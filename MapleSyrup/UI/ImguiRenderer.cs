...
{
    /// <summary>
    /// ImGui renderer for use with XNA-likes (FNA & MonoGame) Credits: https://github.com/ImGuiNET/ImGui.NET/blob/master/src/ImGui.NET.SampleProgram.XNA/ImGuiRenderer.cs
    /// </summary>
    public class ImGuiRenderer
    {
        ...
        protected virtual void UpdateInput()
        {
            ...
            io.AddMouseWheelEvent(
                (mouse.X - _horizontalScrollWheelValue) / WHEEL_DELTA,
                (mouse.ScrollWheelValue - _scrollWheelValue) / WHEEL_DELTA);
            _scrollWheelValue = mouse.ScrollWheelValue;
            _horizontalScrollWheelValue = mouse.X;
